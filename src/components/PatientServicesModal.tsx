...
import { Search, X, ShoppingCart, Heart, Stethoscope, Activity, Users, Pill, Shield, Baby, Filter, DollarSign } from 'lucide-react';
...
interface PatientServicesModalProps {
  patient: Patient;
  onClose: () => void;
  onChargePatient: (services: any[], totalAmount: number) => void;
}

export default function PatientServicesModal({ patient, onClose, onChargePatient }: PatientServicesModalProps) {
  ...
  const handleChargePatient = () => {
    ...
    onChargePatient(selectedServices, totalAmount);
    onClose();
  };
        ...
        <div className="p-6">
          ...
          <div className="flex space-x-3 pt-6 border-t mt-6">
            ...
            >
              ...
              <span>Charge Patient - KES {totalAmount.toLocaleString()}</span>
            </button>
            <button
              onClick={onClose}
