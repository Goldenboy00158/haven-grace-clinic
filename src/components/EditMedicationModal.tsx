...
export default function EditMedicationModal({ medication, onSave, onClose }: EditMedicationModalProps) {
  const [editedMedication, setEditedMedication] = useState<Medication>({
    ...medication,
    formulations: medication.formulations || []
  });
      ...
      <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditedMedication(prev => ({ ...prev, name: e.target.value }))}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditedMedication(prev => ({ ...prev, category: e.target.value }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                min="0"
                step="0.01"
                value={editedMedication.costPrice || 0}
                onChange={(e) => setEditedMedication(prev => ({ ...prev, costPrice: parseFloat(e.target.value) || 0 }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            <div>
              ...
              <input
                ...
                min="0"
                step="0.01"
                value={editedMedication.price}
                onChange={(e) => setEditedMedication(prev => ({ ...prev, price: parseFloat(e.target.value) || 0 }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
              />
            </div>
            <div>
              ...
              <input
                type="number"
                min="0"
                value={editedMedication.stock}
                onChange={(e) => setEditedMedication(prev => ({ ...prev, stock: parseInt(e.target.value) || 0 }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditedMedication(prev => ({ ...prev, manufacturer: e.target.value }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            <div>
              ...
              <input
                type="text"
                value={editedMedication.batchNumber || ''}
                onChange={(e) => setEditedMedication(prev => ({ ...prev, batchNumber: e.target.value }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              type="date"
              value={editedMedication.expiryDate || ''}
              onChange={(e) => setEditedMedication(prev => ({ ...prev, expiryDate: e.target.value }))}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => setEditedMedication(prev => ({ ...prev, description: e.target.value }))}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              rows={3}
            />
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {editedMedication.formulations?.map((formulation, index) => (
